...
@Component({
  ...
  styleUrls: ['./exemple-table.component.scss']
})
export class ExempleTableComponent implements OnInit {
  ...
  constructor(formBuilder: FormBuilder) {
    this.dataSource.filterPredicate = ((data: PeriodicElement, filter: PeriodicElement) => {
